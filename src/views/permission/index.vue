  ...
  <div class="dashboard-container">
    <div class="app-container">
      ...
      <el-table border :data="list" row-key="id">
        ...
        <el-table-column align="center" label="描述" prop="descrition" />
        <el-table-column align="center" label="操作">
          <template v-slot="{ row }">
            <!-- 添加按钮只在 访问权的层级显示 当 type === 1 时才显示添加按钮 -->
...
<script>
import { getPermissionList, getPermissionDetail, delPermission, addPermission, updatePermission } from '@/api/permission'
...
export default {
  ...
  methods: {
    ...
    btnOK() {
      // this.$refs.permForm.validate().then(isOK => {})
